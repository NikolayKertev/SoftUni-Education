    ...
    class Program
    {
        ...
        static int MaxEvenOdd(int[] array, string[] input)
        {
            ...
            for (int i = 0; i < array.Length - 1; i++)
            {
                if (input [1] == "even")
                {
                    if (array[i] > array[IndexForMethods(array, i)] && array[i] > currentMax && array[i] % 2 == 0)
                    {
                        currentMax = array[i];
                        maxIndex = i;
                    }
                    else if (array[IndexForMethods(array, i)] >= currentMax && array[IndexForMethods(array, i)] % 2 == 0)
                    {
                        currentMax = array[IndexForMethods(array, i)];
                        maxIndex = IndexForMethods(array, i);
                    }
                }
                else if (input [1] == "odd")
                {
                    if (array[i] > array[IndexForMethods(array, i)] && array[i] > currentMax && array[i] % 2 == 1)
                    {
                        currentMax = array[i];
                        maxIndex = i;
                    }
                    else if (array[IndexForMethods(array, i)] >= currentMax && array[IndexForMethods(array, i)] % 2 == 1)
                    {
                        currentMax = array[IndexForMethods(array, i)];
                        maxIndex = IndexForMethods(array, i);
                    }
        ...
        static int MinEvenOdd(int[] array, string[] input)
        {
            ...
            for (int i = 0; i < array.Length - 1; i++)
            {
                if (input[1] == "even")
                {
                    if (array[i] < array[IndexForMethods(array, i)] && array[i] < currentMin && array[i] % 2 == 0)
                    {
                        currentMin = array[i];
                        minIndex = i;
                    }
                    else if (array[IndexForMethods(array, i)] <= currentMin && array[IndexForMethods(array, i)] % 2 == 0)
                    {
                        currentMin = array[IndexForMethods(array, i)];
                        minIndex = IndexForMethods(array, i);
                    }
                }
                else if (input[1] == "odd")
                {
                    if (array[i] < array[IndexForMethods(array, i)] && array[i] < currentMin && array[i] % 2 == 1)
                    {
                        currentMin = array[i];
                        minIndex = i;
                    }
                    else if (array[IndexForMethods(array, i)] <= currentMin && array[IndexForMethods(array, i)] % 2 == 1)
                    {
                        currentMin = array[IndexForMethods(array, i)];
                        minIndex = IndexForMethods(array, i);
                    }
        ...
        static string[] FirstEvenOdd(int[] array, string[] input, int n)
        {
            ...
            for (int k = 0; k < array.Length; k++)
            {
                if (input[2] == "even")
                {
                    if (array[IndexForMethods(array, k - 1)] % 2 == 0)
                    {
                        counter++;
                        result += array[IndexForMethods(array, k - 1)].ToString() + ",";
                    }
                }
                else if (input[2] == "odd")
                {
                    if (array[IndexForMethods(array, k - 1)] % 2 == 1)
                    {
                        counter++;
                        result += array[IndexForMethods(array, k - 1)].ToString() + ",";
                    }
        ...
        static int IndexForMethods(int[] array, int i)
        {
